...
<div id="form-container container ">
    <div class="col-8 offset-3">
        ...
        <form:form action="${pageContext.request.contextPath}/teacher/saveTeacher" modelAttribute="teacher"
                   method="POST">
            ...
            <div class="form-row">
                <div class="column">
                    ...
                    <div class="form-group">
                        <label for="teacher_type" class="col-sm-6 col-form-label">Stopień awansu zawodowego:</label>
                        <div class="col-sm-10">
            ...
            <div class="form-group row">
                <div class="col-sm-9 offset-sm-3">
                    ...
                    <a class="btn btn-primary" href="${pageContext.request.contextPath}/teacher/list">Powrót do
                        listy</a>

...
<div id="container">
    ...
    <form:form action="${pageContext.request.contextPath}/teacher/saveSickLeave/${teacher.id}"
        ...
        <table>
            ...
            <tr>
                ...
                <td><form:input type="date" path="sickLeaveFrom"/></td>
            </tr>

            <tr>
                <td><label>Sick leave end date:</label></td>
                <td><form:input type="date" path="sickLeaveTo"/></td>
            </tr>
